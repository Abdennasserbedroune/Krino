...
class Settings(BaseSettings):
    ...
    # HuggingFace Inference API (Parler-TTS)
    HF_API_TOKEN: str = ""  # Optional — enables server-side TTS; falls back to browser SpeechSynthesis

    # NVIDIA NIM (Magpie-TTS — optional, priority 1 over Parler-TTS)
    NVIDIA_API_KEY: str = ""  # Optional — set to enable NVIDIA Magpie-TTS

    # OpenRouter (Nemotron Omni STT — used by live interview transcription)
    OPENROUTER_API_KEY: str = ""  # Required for live interview voice mode
